...
import { User, Lock, Wallet, Skull, Bot, Trophy, Zap, Ghost } from 'lucide-react';
          ...
          >
            ...
            <div className="relative p-3 flex items-center justify-between">
              ...
              <div className="text-right">
                 ...
                 <div className={`font-mono font-bold text-sm ${player.slashed ? 'text-red-400' : isJackpotBot ? 'text-amber-400' : isTaxBot ? 'text-purple-400' : isFirst ? 'text-emerald-400' : 'text-slate-400'}`}>
